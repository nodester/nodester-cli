...
exports.warn = function (str) {
  console.warn(process.nodester.brand.magenta, 'warn'.yellow, strArgs(arguments));
}

exports.error = function (str) {
  console.error(process.nodester.brand.magenta, 'ERROR'.red.inverse, strArgs(arguments));
  process.exit(1);
}
